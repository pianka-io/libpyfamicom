...
void adc_75(struct cpu_t*); // zero x, size 2, cycles 4
void adc_79(struct cpu_t*); // absolute y, size 3, cycles 4/5
void adc_7d(struct cpu_t*); // absolute x, size 3, cycles 4/5
...
void and_35(struct cpu_t*); // zero x, size 2, cycles 4
void and_39(struct cpu_t*); // absolute y, size 3, cycles 4/5
...
void asl_16(struct cpu_t*); // zero x, size 2, cycles 6
void asl_1e(struct cpu_t*); // absolute x, size 3, cycles 7
...
void cmp_d5(struct cpu_t*); // zero x, size 2, cycles 4
void cmp_d9(struct cpu_t*); // absolute y, size 3, cycles 4/5
void cmp_dd(struct cpu_t*); // absolute x, size 3, cycles 4/5
...
void dec_d6(struct cpu_t*); // zero x, size 2, cycles 6
void dec_de(struct cpu_t*); // absolute x, size 3, cycles 7
...
void eor_55(struct cpu_t*); // zero x, size 2, cycles 4
void eor_59(struct cpu_t*); // absolute y, size 3, cycles 4/5
...
void inc_f6(struct cpu_t*); // zero x, size 2, cycles 6
void inc_fe(struct cpu_t*); // absolute x, size 3, cycles 7
...
void lda_b5(struct cpu_t*); // zero x, size 2, cycles 4
void lda_b9(struct cpu_t*); // absolute y, size 3, cycles 4/5
...
void ldx_b6(struct cpu_t*); // zero y, size 3, cycles 4
...
void ldy_b4(struct cpu_t*); // zero x, size 2, cycles 4
void ldy_bc(struct cpu_t*); // absolute x, size 3, cycles 4/5
...
void lsr_56(struct cpu_t*); // absolute, size 2, cycles 6
void lsr_5e(struct cpu_t*); // absolute x, size 3, cycles 7
...
void ora_15(struct cpu_t*); // zero x, size 2, cycles 4
void ora_19(struct cpu_t*); // absolute y, size 3, cycles 4/5
void ora_1d(struct cpu_t*); // absolute x, size 3, cycles 4/5
...
void rol_36(struct cpu_t*); // zero x, size 2, cycles 6
void rol_3e(struct cpu_t*); // absolute x, size 3, cycles 7
...
void ror_76(struct cpu_t*); // zero x, size 2, cycles 6
void ror_7e(struct cpu_t*); // absolute x, size 3, cycles 7
...
void sbc_f1(struct cpu_t*); // indirect indexed, size 2, cycles 5/6
void sbc_f5(struct cpu_t*); // zero x, size 2, cycles 4
void sbc_f9(struct cpu_t*); // absolute y, size 3, cycles 4/5
void sbc_fd(struct cpu_t*); // absolute x, size 3, cycles 4/5
...
void stx_96(struct cpu_t*); // zero y, size 2, cycles 4
void sty_84(struct cpu_t*); // zero, size 2, cycles 3
void sty_8c(struct cpu_t*); // absolute, size 3, cycles 4
void sty_94(struct cpu_t*); // zero x, size 2, cycles 4
